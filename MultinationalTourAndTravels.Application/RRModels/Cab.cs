...
{
    public record CabRequest([IsFileImage("image/jpeg", "image/png",ErrorMessage = "Please provide a jpeg or png file")] IFormFile File,string Name,string Description,double Price,CabType CabType);
